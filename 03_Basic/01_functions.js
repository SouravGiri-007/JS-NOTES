...
function addTwoNumbers2(number1, number2) {
    ...
    // return result
    /* console.log("sOURAV"); This will never be excecuted cause after return function
    doesn't work. */
}
...
// console.log(userLogin("sOURAV")); // Output: Ayush just logged in.
...
// console.log(userLogin2("sOURAV"));
// Output: soURAV just logged in. 

// (iii)
function userLogin3(username = "ram"){
    return `${username} just logged in.`
}
console.log(userLogin3()); // Output: sam just logged in.
console.log(userLogin3("Sourav")); // Output: Ayush just logged in.